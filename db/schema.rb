...
ActiveRecord::Schema.define(version: 20_180_325_184_856) do
  ...
  create_table 'assigned_projects', force: :cascade do |t|
    ...
    t.bigint 'process_id'
    t.index ['course_project_instance_id'],
            name: 'index_assigned_projects_on_course_project_instance_id'
  ...
  create_table 'professors', force: :cascade do |t|
    ...
    t.index %w[uid provider], name: 'index_professors_on_uid_and_provider', unique: true
  end
