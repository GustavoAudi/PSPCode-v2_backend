...
User.create! first_name: 'gustavo', last_name: 'audi', password: '12345678',
             email: 'gusta97_2009@hotmail.com', approved_subjects: ['Calc 2'], programming_language: 'Java', have_a_job: true, job_role: 'Software Engineer', academic_experience: 'Finishing University', programming_experience: 'senior', course: Course.first, professor: Professor.third
